...
@Component({
  selector: 'app-contact-groups-detail-instructions',
  templateUrl: './contact-groups-detail-instructions.component.html',
  styleUrls: ['./contact-groups-detail-instructions.component.scss']
})
