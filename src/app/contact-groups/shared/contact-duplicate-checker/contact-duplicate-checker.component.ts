...
export class ContactDuplicateCheckerComponent implements OnInit, OnChanges {
  ...
  createNewContactGroupPerson(event) {
    ...
    this.router.navigate(['contact-centre', 'detail', 0, 'edit'], {
      queryParams: { newPerson: JSON.stringify(this.newPerson) }
    })
  }
